export default {
  ...
  brightness: {
    ...
    high: "a-brightness-high-symbolic",
    medium: "a-brightness-medium-symbolic",
    low: "a-brightness-low-symbolic",
  },
  powermenu: {
  ...
  network: {
    ...
    transmit: "network-transmit-receive-symbolic",
    firewall: "a-shield-symbolic",
  },
};
